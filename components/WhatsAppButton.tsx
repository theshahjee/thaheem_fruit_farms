...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-glow transition-transform duration-300 hover:scale-110 md:bottom-8 md:right-8 md:h-16 md:w-16"
    >
      <span className="absolute inset-0 -z-10 animate-ping rounded-full bg-[#25D366] opacity-30 group-hover:opacity-50" />
      <svg
        viewBox="0 0 32 32"
        fill="currentColor"
