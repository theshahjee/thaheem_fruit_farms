...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-5px_rgba(37,211,102,0.55)] ring-[3px] ring-white/70 transition-all duration-300 hover:h-16 hover:w-16 active:scale-95 sm:h-16 sm:w-16"
    >
      <svg
        viewBox="0 0 32 32"
        fill="currentColor"
